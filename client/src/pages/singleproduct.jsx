     ...
     <div class="container px-5 py-24 mx-auto">
      <div class="lg:w-4/5 mx-auto flex flex-wrap">
        <div class="lg:w-1/2 w-full lg:pr-10 lg:py-6 mb-6 lg:mb-0">
          ...
          <div class="flex mb-4">
            <a class="flex-grow text-indigo-500 border-b-2 border-indigo-500 py-2 text-lg px-1">{singleProduct?.description}</a>
          ...
          <div class="flex">
            <span class="title-font font-medium text-2xl text-gray-900">{setSingleProduct?.price}</span>
